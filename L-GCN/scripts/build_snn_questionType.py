...
parser.add_argument('-q', '--question-type', help='type of question: What, Who, ...')
parser.add_argument(
    '-o', '--output-path',
    default='cache/tgif'
)
